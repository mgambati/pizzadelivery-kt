...
class CustomersIndexController : Initializable {
    @FXML
    lateinit var table: TableView<Customer>

    @FXML
    lateinit var nameColumn: TableColumn<Customer, String>

    @FXML
    lateinit var phoneColumn: TableColumn<Customer, String>
    ...
    fun findAllCustomers(): ObservableList<Customer> {
